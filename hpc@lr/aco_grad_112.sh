...
python3 ant/src/init_acograd.py -f data/Directio_site32k.csv -c 112 -s 0.5
...
python3 ant/src/init_acograd.py -f data/UCI_household_power_consumption116k.csv -c 112 -s 0.6
python3 ant/src/init_acograd.py -f data/UCI_household_power_consumption116k.csv -c 112 -s 0.7
python3 ant/src/init_acograd.py -f data/UCI_household_power_consumption116k.csv -c 112 -s 0.8
python3 ant/src/init_acograd.py -f data/UCI_household_power_consumption116k.csv -c 112 -s 0.9

python3 ant/src/init_acograd.py -f data/c2k.csv -c 112 -s 0.5
python3 ant/src/init_acograd.py -f data/c2k.csv -c 112 -s 0.6
python3 ant/src/init_acograd.py -f data/c2k.csv -c 112 -s 0.7
python3 ant/src/init_acograd.py -f data/c2k.csv -c 112 -s 0.8
python3 ant/src/init_acograd.py -f data/c2k.csv -c 112 -s 0.9

python3 ant/src/init_acograd.py -f data/breast_cancer.csv -c 112 -s 0.5
python3 ant/src/init_acograd.py -f data/breast_cancer.csv -c 112 -s 0.6
python3 ant/src/init_acograd.py -f data/breast_cancer.csv -c 112 -s 0.7
python3 ant/src/init_acograd.py -f data/breast_cancer.csv -c 112 -s 0.8
python3 ant/src/init_acograd.py -f data/breast_cancer.csv -c 112 -s 0.9

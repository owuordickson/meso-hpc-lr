...
python3 swarm_gp/src/main.py -a 'lcm' -c 14 -f data/aps_2k.csv
python3 swarm_gp/src/main.py -a 'lcm' -c 14 -f data/breast_cancer.csv
python3 swarm_gp/src/main.py -a 'lcm' -c 14 -f data/c2k.csv
python3 swarm_gp/src/main.py -a 'lcm' -c 14 -f data/directio8k.csv
python3 swarm_gp/src/main.py -a 'lcm' -c 14 -f data/hcv_data.csv
python3 swarm_gp/src/main.py -a 'lcm' -c 14 -f data/Omnidir_site2k.csv
python3 swarm_gp/src/main.py -a 'lcm' -c 14 -f data/power_consumption10k.csv

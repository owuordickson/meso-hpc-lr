...
python3 spectral_gp/src/main.py -a 'clugrad' -c 14 -f data/breast_cancer.csv -e 0.75
python3 spectral_gp/src/main.py -a 'clugrad' -c 14 -f data/air_quality.csv -e 0.75
python3 spectral_gp/src/main.py -a 'clugrad' -c 14 -f data/c2k.csv -e 0.75
python3 spectral_gp/src/main.py -a 'clugrad' -c 14 -f data/directio8k.csv -e 0.75
python3 spectral_gp/src/main.py -a 'clugrad' -c 14 -f data/power_consumption10k.csv -e 0.75
...
python3 spectral_gp/src/main.py -a 'acograd' -c 14 -f data/power_consumption10k.csv
...
python3 spectral_gp/src/main.py -a 'graank' -c 14 -f data/power_consumption10k.csv

...
python3 ant/src/pkg_main/main.py -a 'aco' -f data/Directio_site6k.csv -c 14 -s 0.5
python3 ant/src/pkg_main/main.py -a 'aco' -f data/UCI_household_power_consumption19k.csv -c 14 -s 0.5
